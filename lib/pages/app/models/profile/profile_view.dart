...
import 'package:my_app/pages/app/models/profile/components/profile_card.dart';
            ...
            children: [
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return PostTypeChips(
                      isSelected: selectedPostType == index,
                      onTap: () {
                        setState(() {
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return PostCard(
                    onTap: () {
                      Get.to(() => PostDetailPage(post: dummyPosts[index]));
                    },
